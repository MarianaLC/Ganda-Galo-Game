...
class GandaGaloWindow:
    ...
    def __init__(self, cell_size, linhas, colunas):
        ...
        self.puzzle = GraphWin("GandaGalo", self.nlinhas * self.cell_size + self.cell_size, self.ncolunas * self.cell_size + self.cell_size)
        pass   
    ...
    def mostraJanela(self, matriz):
        '''
        Percorre o puzzle, linha a linha e dentro de cada linha coluna a coluna, desenhando cada casa correspondente no puzzle
        '''
        try:
            ...
            for line in matriz:
                for simbolo in line:
                    ...
                    if simbolo == '.':
                        ...
                        self.desenhaCasaBloqueadaNum(coluna + 1, linha + 1, "?")
                    coluna = coluna + 1
                coluna = 0
                linha = linha + 1
